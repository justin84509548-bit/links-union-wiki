...
export const teamMembers = [
  ...
  [
    ...
    "Student Researcher",
    "/assets/emily-li.jpg",
    "My name is Emily Li. I am an eighth-grade student preparing to enter ninth grade. In eighth grade, I joined the biology club at my previous school and conducted several simple biology experiments. I am very interested in biology because I believe it will play an important role in our future lives. In my spare time, I enjoy drawing, reading, and observing plants and animals in nature. I joined the iGEM team because I believe it is a great opportunity to learn more about biology and gain hands-on experience using laboratory equipment.",
    "50% 76%",
    "50% 52%",
  ],
  ["JY", "Jing Ye", "Biological Mentor"],
  ["JQ", "John Qu", "Student Researcher", "/assets/john-qu.jpg", "My name is Qu Jue (John). I was born in 2010 and am based in Chengdu, Sichuan. I’m an ISFP-type introvert. I tend to experience social anxiety, so I feel more comfortable in quiet settings than in busy social situations. I value inner feelings and personal experiences.", "50% 42%", "50% center"],
  ["JY", "Justin Yan", "Art & Design Group Co-leader", "/assets/justin-member.jpg", "Hi everyone! I’m Justin, a 16-year-old student at Shenzhen International Foundation College. In our iGEM team, I am one of the leaders of the Art and Design Group. I mainly work on the team’s Wiki, visual design, and task planning. Although handling several projects at the same time can be challenging, I enjoy turning our scientific ideas into designs that are clear, creative, and easy to understand. iGEM has also given me the opportunity to take part in laboratory work and learn more about biology through real experiments. For me, this experience is not only about science—it is also about creativity, collaboration, and learning how to take responsibility.", "56% 50%", "70% center"],
  ["KL", "Kiki Lü", "Business Group Leader", "/assets/kiki-lu.jpg", "Curious by nature and strategic by personality, I'm an INTJ who loves exploring how biology can solve real-world problems. My name is Kiki Xinqi Lu, and I'm a 15-year-old Grade 10 student at The ISF Academy in Hong Kong. As the leader of the business group and a member of the wiki group, promotion video group, and HP group, I joined iGEM because I'm fascinated by microbiology, bioengineering, and public health. Through iGEM, I've expanded my wet-lab experience and developed my leadership, teamwork, and communication skills. Outside of iGEM, I enjoy debate, martial arts, tennis, piano, and cello. I'm also passionate about service, helping others, and contributing to my community. In the future, I hope to explore public health and bioarchaeology. My favorite quote is Descartes’ “Cogito, ergo sum”—I think, therefore I am.", "50% 52%", "50% center"],
  ["LL", "Lion Li", "Student Researcher", "/assets/lion-li.jpg", "I'm LionLi from BIGZ, 17 years old. My MBTI is ESTJ, and my hobby is scuba diving. iGEM honed my hands-on skills and made me a more qualified and outstanding scholar.", "50% 52%", "50% center"],
  ["LZ", "Lucern Zhang", "Student Researcher"],
  ["QL", "Queenie Li", "Human Practices & Art Group Member", "/assets/queenie-li.jpg", "Hi! My name is Queenie Li, and I’m a junior at Dock Mennonite Academy in Pennsylvania. In our iGEM team, I mainly work in the Human Practices (HP) Group and the Art & Design Group. I helped design our team uniforms and merchandise, created visual materials, conducted surveys, and participated in other activities. I also took part in laboratory experiments, which gave me a better understanding of our project from both the research and practical perspectives. I’m an ENFP, so I enjoy working with people, sharing ideas, and bringing creativity to our team. I’m excited to keep learning and contribute to making our project meaningful and impactful.", "50% 44%", "50% center"],
  ["RJ", "Riley Ji", "Student Researcher", "/assets/riley-ji.jpg", "I'm Riley (Ji Ran), 17, from The Affiliated International School of Shenzhen University, and a LINKS-UNION iGEM member. Outgoing and sociable, I easily make friends and fit into any new space. My interests are broad—I'm passionate about exploring all the beautiful things in the world, from singing and guitar to photography and travel. I believe biology holds that same wonder, and through iGEM, I want to share it. Can't wait to create something meaningful with this team!", "50% 30%", "50% 38%"],
  ["SL", "Subrina Lin", "Student Researcher", "/assets/subrina-lin.jpg", "Hi everyone! I am Subrina Lin, a 17-year-old member of AISSU. I have a deep passion for biology and take great pleasure in conducting various experiments. In my spare time, I enjoy playing MOBA and FPS games, reading books, and doing editing work. My personal belief is that I don’t fight with those who can beat me. Joining iGEM allows me to explore biological knowledge further and gain valuable teamwork experience.", "50% 42%", "50% 48%"],
  ["SS", "Sue Sun", "Video Group Leader", "/assets/sue-member.jpg", "Hi! This is Sue from Wuxi, China. I’m currently an 11th grader studying at Ridley College in Canada. I’m part of LINKS-UNION and serve as a leader in the Video Group, where I contribute to developing and enhancing our promotional and presentation videos. I also contribute to the Education, Human Practices, Business, Wiki, and Design groups. My passion for biology, psychology, and hands-on experiments led me to iGEM, where I hope to further develop my communication, research, and creative-thinking skills. Outside the lab, I enjoy participating in multiple co-curricular clubs and am especially passionate about violin and basketball. Through public performances and teamwork, I have developed stronger resilience and a greater sense of responsibility. In the future, I hope to major in neuroscience. With experimental research experience and collaboration skills, iGEM is helping me learn to think outside the box and work toward becoming a better neuroscientist. Finally, a quote from Santiago Ramón y Cajal, whom I’ve recently read about: “Any man could, if he were so inclined, be the sculptor of his own brain.”", "38% 82%", "38% 62%"],
  ["TK", "Tik Kong", "Art & Design Group Co-leader", "/assets/tik-kong.jpg", "Hi everyone! I am Tik Kong, and I am currently a sophomore at The Stony Brook School. I turned 16 in June, and so far iGEM has been a fantastic experience! Apart from the lab experiments, where I learned many new things, I also enjoyed seeing how people collaborate to solve a complex issue and how the workflow can be divided among team members. I am currently a captain of the Art and Design Group alongside Justin, and we make sure to distribute weekly plans and objectives for our team. This leadership experience has helped me extensively, which was part of what I hoped to gain when I decided to join iGEM. I am interested in biology and chemistry, and while I am not an expert in either area, I enjoy the experimental process and seeing how a single cell can develop into something functional through our own work. As Ralph Waldo Emerson said, “Life is a journey, not a destination.” iGEM is definitely a unique experience that will enhance my technical skills, regardless of how much I doubted myself at the beginning.", "50% 40%", "50% 44%"],
  [
    "TW",
    "Tina Wang",
    "Student Researcher",
    "/assets/tina-wang.jpg",
    "Hi! My name is Tina, and I am a high school student interested in biology, business, and solving real-world problems. I joined our iGEM team because I wanted to explore how synthetic biology can be applied beyond the laboratory. Through iGEM, I have learned more about teamwork, research, communication, and how to consider a project from scientific, social, and business perspectives. Outside iGEM, I enjoy learning about economics, law, and healthcare. In the future, I hope to apply these skills to school projects, research, and other interdisciplinary challenges. My favorite quote is, \u201cStay curious and keep moving forward.\u201d",
    "70% 66%",
    "70% 58%",
  ],
  ["TY", "Tony Yuan", "Academic Group Researcher", "/assets/tony-yuan.jpg", "I am Tony, a current junior studying at the American International School of Guangzhou. Outside school, I enjoy playing sports such as table tennis and football (soccer). I joined iGEM because of my passion for biology and my interest in pursuing biomedical engineering in the future. Joining iGEM has allowed me to learn more about how experiments work in synthetic biology. Within our iGEM team, I mainly serve as a researcher in the Academic Group, gathering and providing the information needed to support our experiments.", "50% 28%", "50% 35%"],
